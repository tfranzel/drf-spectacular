...
class AutoSchema(ViewInspector):
    ...
    def _get_serializer_field_meta(self, field, direction):
        ...
        if (
            ...
            if isinstance(
                field, (serializers.ModelField, serializers.SerializerMethodField)
            ):
    ...
    def _get_request_body(self):
        ...
        if isinstance(request_serializer, dict):
            ...
            for media_type, serializer in request_serializer.items():
                ...
                ) = self._get_request_for_media_type(serializer)
            ...
            content = [
                (
                    media_type,
                    schema,
                    self._get_examples(request_serializer, "request", media_type),
                )
